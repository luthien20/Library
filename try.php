...
<body class="bg-gray-50 min-h-screen">
    ...
    <div id="loginPage" class="library-bg min-h-screen flex items-center justify-center px-4">
        <div class="bg-white bg-opacity-90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 w-full max-w-md">
            <div class="text-center mb-8">
                <div class="text-6xl mb-4">📚</div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">University Library</h1>
            ...
            <form onsubmit="handleLogin(event)" class="space-y-6">
                <div>
                    ...
                    <input type="text" id="loginEmail" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Enter your email or username">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Password</label>
                    <input type="password" id="loginPassword" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Enter your password">
                </div>
                ...
                <button type="button" onclick="showForgotPassword()" class="w-full text-blue-600 hover:text-blue-800 py-2 text-sm transition-colors">
                    Forgot Password?
                </button>
            </form>
            ...
            <div class="mt-6 text-center">
                ...
                <button onclick="showRegistrationPage()" class="text-blue-600 hover:text-blue-800 font-medium text-sm transition-colors">
                    Create New Account
                </button>
            </div>
